 ...
 */
function agamasmaka_customize_register( $wp_customize ) {
	$color_scheme = agamasmaka_get_color_scheme();
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'agamasmaka_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'agamasmaka' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => agamasmaka_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'agamasmaka' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'agamasmaka' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'agamasmaka' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'agamasmaka' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'agamasmaka' );
}
add_action( 'customize_register', 'agamasmaka_customize_register', 11 );

/**
 * Register color schemes for Twenty Fifteen.
 *
 * Can be filtered with {@see 'agamasmaka_color_schemes'}.
 *
 ...
 */
function agamasmaka_get_color_schemes() {
	return apply_filters( 'agamasmaka_color_schemes', array(
		'default' => array(
...
if ( ! function_exists( 'agamasmaka_get_color_scheme' ) ) :
/**
 ...
 */
function agamasmaka_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = agamasmaka_get_color_schemes();
...
endif; // agamasmaka_get_color_scheme

if ( ! function_exists( 'agamasmaka_get_color_scheme_choices' ) ) :
/**
 ...
 */
function agamasmaka_get_color_scheme_choices() {
	$color_schemes                = agamasmaka_get_color_schemes();
...
endif; // agamasmaka_get_color_scheme_choices

if ( ! function_exists( 'agamasmaka_sanitize_color_scheme' ) ) :
/**
 ...
 */
function agamasmaka_sanitize_color_scheme( $value ) {
	$color_schemes = agamasmaka_get_color_scheme_choices();
...
endif; // agamasmaka_sanitize_color_scheme
 ...
 */
function agamasmaka_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = agamasmaka_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = agamasmaka_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = agamasmaka_get_color_scheme_css( $colors );

	wp_add_inline_style( 'agamasmaka-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'agamasmaka_color_scheme_css' );
 ...
 * @since Aga ma smaka 1.0
 */
function agamasmaka_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', agamasmaka_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'agamasmaka_customize_control_js' );
 ...
 * @since Aga ma smaka 1.0
 */
function agamasmaka_customize_preview_js() {
	wp_enqueue_script( 'agamasmaka-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'agamasmaka_customize_preview_js' );
 ...
 */
function agamasmaka_get_color_scheme_css( $colors ) {
 ...
 * @since Aga ma smaka 1.0
 */
function agamasmaka_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-agamasmaka-color-scheme">
		<?php echo agamasmaka_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'agamasmaka_color_scheme_css_template' );
