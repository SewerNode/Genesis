			...
			?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<nav id="image-navigation" class="navigation image-navigation">
						<div class="nav-links">
							<div class="nav-previous"><?php previous_image_link( false, __( 'Previous Image', 'agamasmaka' ) ); ?></div><div class="nav-next"><?php next_image_link( false, __( 'Next Image', 'agamasmaka' ) ); ?></div>
						</div><!-- .nav-links -->
					...
					<div class="entry-content">
						...
						<div class="entry-attachment">
							<?php
								 ...
								 */
								$image_size = apply_filters( 'agamasmaka_attachment_size', 'large' );
				...
				<?php
					...
					the_post_navigation( array(
						'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'agamasmaka' ),
					) );
